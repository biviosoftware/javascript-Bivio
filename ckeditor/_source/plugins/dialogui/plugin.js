...
(function()
{
    ...
    CKEDITOR.tools.extend( CKEDITOR.ui.dialog,
        /** @lends CKEDITOR.ui.dialog */
        {
		   ...
		   CKEDITOR['g_textInput_' + elementDefinition.exportElement ] = this;
             ...
             * List of HTML code to output to.
             */
            bop_file_upload : function( dialog, elementDefinition, htmlList )
            {
                if ( arguments.length < 3 )
                    return;
			...
			'<script type="text/javascript">' +
		        '</script>' +
                        '<iframe' +
                        ' id="', _.frameId, '"' +
                        ' src="' + CKEDITOR.config.filebrowserImageUploadUrl + '"' +
    ...
    CKEDITOR.ui.dialog.bop_file_upload.prototype = CKEDITOR.tools.extend( new CKEDITOR.ui.dialog.labeledElement,
            commonPrototype,
            {
            }, true );
    ...
    CKEDITOR.dialog.addUIElement( 'bop_file_upload', commonBuilder );

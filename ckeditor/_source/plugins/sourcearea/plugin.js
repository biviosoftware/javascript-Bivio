...
CKEDITOR.plugins.add( 'sourcearea',
{
    ...
    init : function( editor )
    {
        ...
        var displayLineNumber = function(evt)
        {
            var target = evt.data.getTarget();
            var curpos = target.getSelectionStart();
            var contents = target.getValue();
            var lineNr = 1;
            var column = 1;         
            // alert(curpos + '\n' + contents.substr(0, curpos));
            ...
            getSpaceElement().setHtml('<div style="color: gray">Line ' + lineNr + '&nbsp;&nbsp;Column ' + column + '</div>');
            return 1;
        }
                ...
                editor.addMode( 'source',
                    {
                        load : function( holderElement, data )
                        {
                            ...
                            textarea.on('click', displayLineNumber);
                            textarea.on('keyup', displayLineNumber);
